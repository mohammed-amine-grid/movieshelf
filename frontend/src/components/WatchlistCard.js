  ...
  return (
    ...
    <div className='movie-card-overlay'>
        <div className='movie-card-poster-container'>
            ...
            {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/w4owJamctrI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
        </div>

        <div className='movie-card-info'>
         
            <h2 className='movie-card-info-title'>Title</h2>
            <div class="movie-card-info-genre-container">
            ...
            <button className='delete-movie-btn'><TiDeleteOutline color='crimson' size={30}/></button>
            </div>
        </div>
